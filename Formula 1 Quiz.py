# This code is a quiz.It asks you your name and age, also gives you your score at the end.
import easygui 
player_score = 0
counter = 1
...
# This bit of code welcomes you into the game
easygui.msgbox("Hi welcome to my quiz")
easygui.msgbox("This quiz is about Formula one! Test your knowledge")
# This bit checks to make sure you are the right age and welcomes you in the quiz
player_age = int(easygui.enterbox("how old are you?"))
if player_age <= 18 and player_age >= 15:  
    easygui.msgbox("You are the right age for this quiz")
    easygui.msgbox("Welcome to the F1 quiz")
    #This asks for your name and uses your name to welcome you and give you your starting score
    ...
    #These are my 5 questions for my quiz each one has the answer in there and also has points to add if you get it right. If you do get it right it says Great work and if you get it wrong it says sorry you got it wrong.
    ...
    while  answer != "2024" and counter < 2:
        ...
        if answer == "2024":
           ...
           easygui.msgbox(" The answer is 2024")
           counter = 2
    ...
    while  answer != "Until 2028" and counter < 2:
        ...
        if answer == "Until 2028":
           ...
           easygui.msgbox("Sorry you got it wrong. You have no more tries left for this question") 
           easygui.msgbox("The answer is until 2028")
           counter = 2 
    ...
    while  answer != "Lewis" and counter < 2:
        ...
        if answer == "Lewis":
           ...
           easygui.msgbox("Sorry you got it wrong. You have no more trys left for this question")
           easygui.msgbox(" The answer is Lewis")
           counter = 2
    ...
    while answer != "1950" and counter < 2: 
        ...
        if answer == "1950":
           ...
           easygui.msgbox("Sorry you got it wrong. You have no more trys left for this question")
           easygui.msgbox("The answer was 1950")
           counter = 2
    ...
    while answer != "Lando and Oscar" and counter < 2:
        ...
        if answer == "Lando and Oscar":
           ...
           easygui.msgbox("The answer was Lando and Oscar")
           counter = 2
...
if player_age > 18 or player_age < 15:
    easygui.msgbox("You're not the right age to do this quiz.")    
